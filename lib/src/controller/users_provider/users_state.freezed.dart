...
mixin _$UsersState {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(List<User> data) initial,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(List<User> data)? initial,
...
class _$_Initial implements _Initial {
  const _$_Initial(final List<User> data) : _data = data;
  ...
  @override
  String toString() {
    return 'UsersState.initial(data: $data)';
  }
...
abstract class _Initial implements UsersState {
  const factory _Initial(final List<User> data) = _$_Initial;
